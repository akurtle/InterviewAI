  ...
  return (
    <button
                ...
                >
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-3">Interview Analysis</h3>
                  <p className="text-gray-400 mb-4">
                    Upload your interview recording and get detailed feedback on your performance, communication style, and areas for improvement.
                  </p>
