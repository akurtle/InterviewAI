...
function InterviewButton({ handleOptionSelect }: { handleOptionSelect: (option: "interview" | "resume") => void }) {
  return (

    <Link to="/mock-interview" className='group relative bg-gray-900/50 backdrop-blur border-2 border-gray-800 rounded-2xl p-8 hover:border-emerald-500 transition-all duration-300 hover:transform hover:scale-105 text-left'>
